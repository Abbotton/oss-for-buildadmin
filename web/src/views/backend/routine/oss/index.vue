...
const state = reactive({
  ...
  qiniu_region: {
    'https://upload.qiniup.com': '华东-浙江',
    'https://upload-cn-east-2.qiniup.com': '华东-浙江2',
    'https://upload-z1.qiniup.com': '华北-河北',
    'https://upload-z2.qiniup.com': '华南-广东',
    'https://upload-na0.qiniup.com': '北美-洛杉矶',
    'https://upload-as0.qiniup.com': '亚太-新加坡(原东南亚)',
    'https://upload-ap-northeast-1.qiniup.com': '亚太-首尔',
  },
  loading: false,
  formData: {
    // 存储方式
